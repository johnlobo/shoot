...
_aux_txt::
	.ds 40
_changeVideoMemoryPage_page_1_88:
	.ds 1
;--------------------------------------------------------
; ram data
;--------------------------------------------------------
...
;src/main.c:51: static u8 page   = 0;   // Static value to remember the last page shown (0 = page 40, 1 = page C0)
	ld	iy,#_changeVideoMemoryPage_page_1_88
	ld	0 (iy),#0x00
;--------------------------------------------------------
; Home
;--------------------------------------------------------
...
;src/main.c:56: if (page) {
	ld	a,(#_changeVideoMemoryPage_page_1_88 + 0)
	or	a, a
	jr	Z,00102$
...
;src/main.c:58: page = 0;  
	ld	hl,#_changeVideoMemoryPage_page_1_88 + 0
	ld	(hl), #0x00
...
; ---------------------------------
_clear_screen::
;src/main.c:85: cpct_memset_f64(screen, 0x00, 0x4000);   
	pop	bc
	pop	hl
	push	hl
	push	bc
...
00110$:
	...
	pop	ix
	ret
;src/main.c:121: void draw_scoreboard(u8* screen){
;	---------------------------------
...
_draw_scoreboard::
	...
	ld	ix,#0
	add	ix,sp
;src/main.c:122: sprintf(aux_txt,"%08d",get_score());
	call	_get_score
	push	de
	push	hl
	ld	hl,#___str_0
	...
	add	hl,sp
	ld	sp,hl
;src/main.c:123: colour_message(0, 2);
	ld	hl,#0x0200
	push	hl
	call	_colour_message
	pop	af
;src/main.c:124: cpc_PrintGphStr(aux_txt,(int) cpct_getScreenPtr(screen, 4, 8));
	ld	e,4 (ix)
	ld	d,5 (ix)
	push	de
	ld	hl,#0x0804
	...
	call	_red_message
	pop	de
;src/main.c:126: cpc_PrintGphStr("00000000",(int) cpct_getScreenPtr(screen, 60, 8));
	ld	hl,#0x083C
	push	hl
	push	de
	call	_cpct_getScreenPtr
...
___str_1:
	.ascii "00000000"
	.db 0x00
;src/main.c:134: void initialization(){
;	---------------------------------
; Function initialization
; ---------------------------------
_initialization::
;src/main.c:136: pvmem = SCR_BUFF;
	ld	hl,#0x8000
	ld	(_pvmem),hl
;src/main.c:138: cpct_setRandomSeedUniform_u8((u8) get_time());
	call	_get_time
	call	_cpct_setRandomSeedUniform_u8
;src/main.c:141: init_stars();
	call	_init_stars
;src/main.c:143: init_user();
	call	_init_user
;src/main.c:144: init_shoots();
	call	_init_shoots
;src/main.c:145: init_enemies();
	call	_init_enemies
;src/main.c:146: init_explosions();
	call	_init_explosions
;src/main.c:147: init_messages();
	call	_init_messages
;src/main.c:149: block01.x = 50;
	ld	hl,#_block01+0
	ld	(hl),#0x32
;src/main.c:150: block01.y = 10;
	ld	hl,#_block01 + 1
	ld	(hl),#0x0A
;src/main.c:151: block01.vx = 2;
	ld	hl,#_block01 + 2
	ld	(hl),#0x02
;src/main.c:152: block01.vy = 0;
	ld	hl,#_block01 + 3
	ld	(hl),#0x00
;src/main.c:153: block01.w = 20;
	ld	hl,#_block01 + 4
	ld	(hl),#0x14
;src/main.c:154: block01.h = 40;
	ld	hl,#_block01 + 5
	ld	(hl),#0x28
;src/main.c:156: block02.x = 15;
	ld	hl,#_block02+0
	ld	(hl),#0x0F
;src/main.c:157: block02.y = 15;
	ld	hl,#_block02 + 1
	ld	(hl),#0x0F
;src/main.c:158: block02.vx = 4;
	ld	hl,#_block02 + 2
	ld	(hl),#0x04
;src/main.c:159: block02.vy = 0;
	ld	hl,#_block02 + 3
	ld	(hl),#0x00
;src/main.c:160: block02.w = 25;
	ld	hl,#_block02 + 4
	ld	(hl),#0x19
;src/main.c:161: block02.h = 20;
	ld	hl,#_block02 + 5
	ld	(hl),#0x14
	ret
...
; ---------------------------------
_main::
;src/main.c:172: set_stack(0x1000);
	ld	hl,#0x1000
	push	hl
	call	_set_stack
	pop	af
;src/main.c:175: timer_on();
	call	_timer_on
;src/main.c:176: cpct_fw2hw       (palette, 16);   // Convert Firmware colours to Hardware colours 
	ld	de,#_palette
	ld	a,#0x10
	push	af
	inc	sp
	...
	pop	af
	inc	sp
;src/main.c:177: cpct_setPalette  (palette, 16);   // Set up palette using hardware colours
	ld	de,#_palette
	ld	a,#0x10
	push	af
	inc	sp
	...
	pop	af
	inc	sp
;src/main.c:178: cpct_setBorder   (palette[0]);    // Set up the border to the background colour (white)
	ld	a, (#_palette + 0)
	ld	d,a
	ld	e,#0x10
	push	de
	...
	pop	af
;src/main.c:179: cpct_setVideoMode(0);               // Change to Mode 0 (160x200, 16 colours)
	xor	a, a
	push	af
	inc	sp
	call	_cpct_setVideoMode
	inc	sp
;src/main.c:182: clear_screen(SCR_VMEM);
	ld	hl,#0xC000
	push	hl
	call	_clear_screen
;src/main.c:183: clear_screen(SCR_BUFF);
	ld	hl, #0x8000
	ex	(sp),hl
	call	_clear_screen
	pop	af
;src/main.c:185: initialization(); 
	call	_initialization
;src/main.c:186: create_message(25,96,30,";VAMOS;AL;ATAQUE;");
	ld	hl,#___str_2
	push	hl
	ld	hl,#0x1E60
	push	hl
...
00106$:
;src/main.c:191: clear_screen(pvmem);
	ld	hl,(_pvmem)
	push	hl
	call	_clear_screen
	pop	af
;src/main.c:193: update_user();
	call	_update_user
;src/main.c:194: update_shoots();
	call	_update_shoots
;src/main.c:196: update_enemies();
	call	_update_enemies
;src/main.c:197: update_explosions();
	call	_update_explosions
;src/main.c:200: update_stars();
	call	_update_stars
;src/main.c:203: draw_stars(pvmem);
	ld	hl,(_pvmem)
	push	hl
	call	_draw_stars
	pop	af
;src/main.c:206: draw_user(pvmem);
	ld	hl,(_pvmem)
	push	hl
	call	_draw_user
	pop	af
;src/main.c:207: draw_shoots(pvmem);
	ld	hl,(_pvmem)
	push	hl
	call	_draw_shoots
	pop	af
;src/main.c:208: draw_enemies(pvmem);
	ld	hl,(_pvmem)
	push	hl
	call	_draw_enemies
	pop	af
;src/main.c:209: draw_explosions(pvmem);
	ld	hl,(_pvmem)
	push	hl
	call	_draw_explosions
	pop	af
;src/main.c:211: draw_messages(pvmem);
	ld	hl,(_pvmem)
	push	hl
	call	_draw_messages
	pop	af
;src/main.c:212: draw_scoreboard(pvmem);
	ld	hl,(_pvmem)
	push	hl
	call	_draw_scoreboard
	pop	af
;src/main.c:218: pvmem = changeVideoMemoryPage();
